...
request.open('GET', 'https://fantasy.espn.com/apis/v3/games/ffl/seasons/2021/segments/0/leagues/1001965?view=mBoxscore', true)
request.onload = function()
{
    ...
    {
        if(data['schedule'][i]['home']['teamId'] == 12 || data['schedule'][i]['away']['teamId'] == 12)
        {
    ...
    let team = data['teams'][11]['location'] + " " + data['teams'][11]['nickname']
    let logo = data['teams'][11]['logo']
